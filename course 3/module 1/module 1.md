# <img src="https://github.com/shimadasoftware/data-analysis-path/assets/73977456/9dfa6ce6-b8d0-44d0-b472-74f530bd4728" alt="Italian Trulli" style="width:25px;height:25px;"> Módulo 1: Tipos y estructuras de datos
...
Por otro lado, los datos ordinales son un conjunto de datos cualitativos con un orden o escala preestablecidos. Si le preguntan a un grupo de gente que califiquen la película del 1 a 5 algunos la calificarán con 2, otros con 4 y así. Estas calificaciones indican cuánto le gustó la película a cada persona. Ahora, hablemos de los datos internos. que son los datos que viven dentro de los propios sistemas de una empresa. 
...
1. Un analista de datos de una editorial de libros está trabajando en un informe urgente para los ejecutivos. Están utilizando solo datos históricos. ¿Cuál es la razón más probable para elegir analizar solo datos históricos?
    ...
    - El proyecto tiene un plazo muy corto
      ...
      ✅ Correcto. La razón más probable para elegir analizar solo datos históricos es que el proyecto tiene un plazo de tiempo muy corto.
    
    - Los datos son desconocidos
    
      ❌ Incorrecto.
      
    - Hay mucho tiempo para investigar los datos históricos
...
2. ¿Cuál de los siguientes es un ejemplo de datos continuos?
    ...
    - Actores principales de una película
    ...
    - El presupuesto de una película
    
      ❌ Incorrecto.
      
    - Tiempo de duración de la película
    
      ✅ Correcto. La duración de la película es un ejemplo de datos continuos.     


3. Los datos cualitativos nominales tienen un orden o escala establecidos.
    ...
    - Falso
      ...
      ✅ Correcto. Los datos cualitativos nominales no tienen un orden o escala establecidos. 


4. ¿Por qué los datos internos se consideran más confiables y fáciles de recopilar que los datos externos?

    - Los datos internos provienen de personas que conoces.
    
      ❌ Incorrecto.
  
    - Los datos internos sortean las restricciones de privacidad.
    
      ❌ Incorrecto.
    
    - Los datos internos están alojados dentro de los propios sistemas de la empresa.
    
      ✅ Correcto. Los datos internos se consideran más confiables y fáciles de recopilar que los datos externos porque están alojados dentro de los propios sistemas de la empresa. 
      
    - Los datos internos tienen un tamaño de muestra mucho mayor.
    
      ❌ Incorrecto.


5. Una publicación en las redes sociales es un ejemplo de datos estructurados.
    ...
    - Falso
      ...
      ✅ Correcto. Una publicación en las redes sociales es un ejemplo de datos no estructurados.


6. Un tipo de dato booleano debe tener un valor numérico.
    ...
    - Falso
      ...
      ✅ Correcto. Un tipo de datos booleanos puede tener muchos tipos de valores diferentes, pero solo puede haber dos de ellos.


![image](./img/module%2001%20img%2028.png)

7. ¿Qué tipo de formato de datos contiene?
    ...
    - Largo
      ...
      ✅ Correcto. La selección de la hoja de cálculo contiene datos en formato largo. 


8. La transformación de datos puede cambiar la estructura de los datos. Un ejemplo de esto es tomar los datos almacenados en un formato y convertirlos en otro.

    - Verdadero
    
      ✅ Correcto. La transformación de datos puede cambiar la estructura de los datos. Un ejemplo de esto es tomar los datos almacenados en un formato y convertirlos en otro.
